...
<mt-navbar class="title" v-model="active" fixed>
  <van-cell is-link @click="showPopup"  style="padding:0;width:45px;height:45px;margin-top:5px;background: linear-gradient(to bottom,rgb(227,232,242),rgb(229,232,234));border:1px solid #ccc;border-radius:50%">
    <img alt="未登录" v-for="(q,i) of liss" :key="i" :src="'http://127.0.0.1:5050/'+q.avatar" class="imgg">
  </van-cell>
...
<div v-for="(q,i) of liss" :key="i"  >
 ...
 <img :src="'http://127.0.0.1:5050/'+q.avatar" class="imgg1">
  <span style="position:relative; top:-25px;">{{q.uname}}</span>
  <div class="position">
    <div class="me"><img src="../assets/me.png"/>与我相关</div>
    <div class="me"><img src="../assets/wjx.png"/>活动中心</div>
    <div class="me"><img src="../assets/thing.png"/>我的任务</div>
    <div class="me"><img src="../assets/my.png"/>我的收藏</div>
    <button class="quit" @click="del">退出登录</button>
 </div>   
 </van-popup>
 </div>
<!-- tab-container -->
    <mt-tab-container class="coa-box" v-model="active" :swipeable="true" value="tab1">
     ...
     <div> <swipe style="margin-top:65px; margin-bottom:20px;" prevent="true" stopPropagation="true"></swipe></div>
      <div>
       <div class="container"   v-for="(p,i) of list" :key="i" @click="recomeed" :data-id="p.id" :data-title="p.title" :data-time="p.time" :data-uid="p.uid" :data-pic="p.pic" :data-text="p.text" :data-nblikes="p.nblikes">
            ...
            <div class="div">
                <img :src="'http://127.0.0.1:5050/'+p.pic" class="img_2" alt="暂时无法显示">
            </div>
            </div>
     ...
     <div style="margin-top:50px">
       <div class="container"  v-for="(e,i) of shuzu" :key="i" @click="toure" :data-id="e.id"  :data-title="e.title" :data-time="e.time" :data-text="e.text" :data-pic="e.pic" :data-nblikes="e.nblikes"> 
            ...
            <div class="div">
                <img :src="'http://127.0.0.1:5050/'+e.pic" class="img_2" alt="暂时无法显示">
            </div>
            </div>
      ...
      <div style="margin-top:50px">
       <div class="container"  v-for="(f,i) of shu" :key="i" @click="strate" :data-id="f.id"  :data-title="f.title" :data-text="f.text" :data-pic="f.pic"> 
            ...
            <div class="div">
                <img :src="'http://127.0.0.1:5050/'+f.pic" class="img_2" alt="暂时无法显示">
            </div>
        </div>
     ...
     <div style="margin-top:50px">
       <div class="video"  v-for="(g,i) of zu" :key="i"> 
            ...
            <div class="div_video">
               <video :src="'http://127.0.0.1:5050/'+g.video" controls="" preload="metadata"  style="object-fit: fill;width:100%;
...
.quit{
    border:1px solid rgb(18,160,188);
    border-radius:10px;
    position:relative;
